								...
								<div className="inline-flex items-center justify-center p-2 rounded-md text-gray-700 hover:text-gray-100 focus:outline-none transition duration-150 ease-in-out">
									<div className="visible xl:hidden">
										<ul className="p-2 border-r bg-white absolute rounded left-0 right-0 shadow mt-8 md:mt-8 hidden">
											<li className="flex xl:hidden cursor-pointer text-gray-600 text-sm leading-3 tracking-normal mt-2 py-2 hover:text-darkPrimaryColor focus:text-darkPrimaryColor focus:outline-none">
											...
											<li className="flex xl:hidden flex-col cursor-pointer text-gray-600 text-sm leading-3 tracking-normal py-2 hover:text-darkPrimaryColor focus:text-darkPrimaryColor focus:outline-none flex justify-center">
												<div className="flex items-center">
													<svg
														xmlns="http://www.w3.org/2000/svg"
											...
											<li className="flex xl:hidden cursor-pointer text-gray-600 text-sm leading-3 tracking-normal py-2 hover:text-darkPrimaryColor flex items-center focus:text-darkPrimaryColor focus:outline-none">
												<svg
													xmlns="http://www.w3.org/2000/svg"
											...
											<li className="border-b border-gray-300 flex xl:hidden cursor-pointer text-gray-600 text-sm leading-3 tracking-normal pt-2 pb-4 hover:text-darkPrimaryColor flex items-center focus:text-darkPrimaryColor focus:outline-none">
												<svg
													xmlns="http://www.w3.org/2000/svg"
											...
											<li className="cursor-pointer text-gray-600 text-sm leading-3 tracking-normal mt-2 py-2 hover:text-darkPrimaryColor flex items-center focus:text-darkPrimaryColor focus:outline-none">
												<div className="flex items-center">
											...
											<li className="cursor-pointer text-gray-600 text-sm leading-3 tracking-normal py-2 hover:text-darkPrimaryColor focus:text-darkPrimaryColor focus:outline-none">
												<div className="flex items-center">
													<svg
														xmlns="http://www.w3.org/2000/svg"
										...
										>
											{profile && (
												<ul className="p-2 w-40 border-r bg-white absolute rounded right-0 shadow top-0 mt-16 ">
													...
													<li className="cursor-pointer text-gray-600 text-sm leading-3 tracking-normal mt-2 py-2 hover:text-darkPrimaryColor focus:text-darkPrimaryColor focus:outline-none flex items-center">
														<svg
															xmlns="http://www.w3.org/2000/svg"
										...
										<ul className="f-m-m">
											<a className="cursor-pointer">
												<li className="text-gray-800 pt-10">
													<div className="flex items-center">
														<div className="w-6 h-6 md:w-8 md:h-8 text-darkPrimaryColor">
															<svg
																xmlns="http://www.w3.org/2000/svg"
																className="icon icon-tabler icon-tabler-grid"
																viewBox="0 0 24 24"
														...
														<p className="text-darkPrimaryColor xl:text-base text-base ml-3">
															Dashboard
														</p>
													</div>
												</li>
