			...
			sections: [
				{
					...
					items: [
						...
						{ name: "Sweaters", href: "#" },
						{ name: "T-Shirts", href: "#" },
						{ name: "Chamarras", href: "men/chamarras" },
						{ name: "Activewear", href: "#" },
						{ name: "Browse All", href: "#" }
					]
				},
	...
	return (
		<div className="bg-white">
			...
			<header className="relative bg-white">
				<p className="bg-primaryColor h-10 flex items-center justify-center text-sm font-medium text-white px-4 sm:px-6 lg:px-8">
